    ...
    for (i, rect) in enumerate(rects):
        ...
        if EAR < EAR_THRESHOLD:
            ...
            if FRAME_COUNT >= CONSECUTIVE_FRAMES:
                ...
                cv2.putText(frame, "EAR: {:.2f}".format(EAR), (10, 70), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
                cv2.putText(frame, "MAR: {:.2f}".format(MAR), (10, 100), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
